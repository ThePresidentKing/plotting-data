...
plot(hpc_table$DateTime, as.numeric(as.character(hpc_table$Global_active_power)),type='l',ylab="Global Active Power", xlab="")

plot(hpc_table$DateTime, as.numeric(as.character(hpc_table$Sub_metering_1)),type='l', xlab="",ylab ="Energy sub metering")
...
plot(hpc_table$DateTime, as.numeric(as.character(hpc_table$Voltage)),type='l', 
    ylab="Voltage",xlab="datetime" )

plot(hpc_table$DateTime, as.numeric(as.character(hpc_table$Global_reactive_power)),type='l', 
